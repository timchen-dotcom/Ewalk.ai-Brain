...
這份表單用來記錄 Mac Studio 原機檢查結果。2026-06-05 起，這份表單不再作為 100% 重置前門檻，而是作為重置後補做清單。
...
- 決策更新：[[2026-06-05_MacStudio風險接受重置策略]]
...
- Mac Studio 是否可重置：可進入風險接受重置，不再追求 100% 稽核
- 還缺什麼：完整只讀稽核六份輸出、排程清單、備份抽查、私密憑證候選路徑盤點、舊 thread 原機補強皆改為重置後補做
