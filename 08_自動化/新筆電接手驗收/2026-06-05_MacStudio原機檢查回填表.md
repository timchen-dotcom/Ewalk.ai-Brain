...
| 優先 | Thread | 狀態 | 摘要檔 |
| --- | --- | --- | --- |
| P0 | 工作交辦窗口 | 待回填 | `舊主機thread交接摘要/P0_工作交辦窗口.md` |
...
| 檢查項目 | 狀態 | 發現內容 | 處理方式 |
| --- | --- | --- | --- |
| Codex Automations | 待回填 |  |  |
| LaunchAgents / LaunchDaemons | 待回填 |  |  |
| crontab | 待回填 |  |  |
| pmset schedule | 待回填 |  |  |
| node / python / firebase / vercel 程序 | 待回填 |  |  |
| ollama / openclaw / codex 程序 | 待回填 |  |  |
| Chrome / 瀏覽器登入依賴 | 待回填 |  |  |
| Discord / 每日交接提醒 | 待回填 |  |  |
| Google Ads / Meta 發文流程 | 待回填 |  |  |
